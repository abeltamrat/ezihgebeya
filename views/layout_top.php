...
<header class="site-header">
  <div class="container header-row">
    ...
    <nav class="main-nav" aria-label="Primary">
      ...
      <a href="<?= url('videos') ?>" class="nav-video"><?= system_ui_icon('play', 'Video') ?> Video</a>
      <a href="<?= url('cart') ?>" title="Cart"><?= system_ui_icon('cart', 'Cart') ?><?= cart_count() ? ' <span class="pill">' . cart_count() . '</span>' : '' ?></a>
